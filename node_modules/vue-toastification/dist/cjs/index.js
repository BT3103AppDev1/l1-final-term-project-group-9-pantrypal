...
const isVueInstanceOrComponent = (obj) => obj instanceof Vue__default['default'] || isVueComponent(obj);
...
function createToastInterface(optionsOrEventBus, Vue = Vue__default['default']) {
