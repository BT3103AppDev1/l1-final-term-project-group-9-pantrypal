...
export interface PluginOptions extends CommonOptions {
     ...
     */
    filterBeforeCreate?: (toast: ToastOptionsAndRequiredContent, toasts: ToastOptionsAndRequiredContent[]) => ToastOptionsAndRequiredContent | false;
    /**
...
export declare type ToastOptionsAndRequiredContent = ToastOptions & {
    content: ToastContent;
};
