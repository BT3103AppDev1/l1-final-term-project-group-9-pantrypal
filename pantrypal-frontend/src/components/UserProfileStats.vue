<template>
    <div class="user-profile-stats">
        ...
        <div class="numberOfRecipesCreated">
            ...
            <div class="category-liked">
                <column-chart :data="recipesCreatedData" xtitle="Month"
                    ytitle="Number of Recipes Created"></column-chart>
            </div>
...
export default {
    ...
    methods: {
        ...
        async fetchLikedRecipesData() {
            ...
            let categoryList = {
                "Asian": 0, "Beverages": 0, "Breakfast and Brunch": 0, "Desserts and Snacks": 0, "Fast Food": 0, "Healthy Choices": 0,
